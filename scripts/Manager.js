...
let bustSpan = 0;
let bustDepth = 0;
let womenFrontSleeveLength = 0;
let womenBackSleeveLength = 0;
(() => {
  resetSvg();
  entryPoint();
  manageButtons();
...
function manageButtons() {
  ...
  document
    .querySelector("#generate_sleeve_pattern")
...
function getMeasurements() {
  ...
  womenFrontSleeveLength = parseFloat(
    document.querySelector("#women_front_sleeve_length").value
  );
  womenBackSleeveLength = parseFloat(
    document.querySelector("#women_back_sleeve_length").value
  );
}
...
function generateFrontBodicePattern() {
  ...
  new Curve().threePointCurveFromPointsArray([
    point10.getPointAsArray(),
    [point2.getX(), point10.getY()],
    point2.getPointAsArray(),
  ]);
  new Curve().fourPointCurveFromPointsArray([
